...
if __name__ == '__main__':
    ...
    writer.close()
    print("")
# tensorboard --logdir=D:\PyCharm\PyCharmWorkPlace\RL-Group\works\eat\logs
# tensorboard --logdir=D:\PyCharm\PyCharmWorkPlace\RL-Group\works\eat\logs_model_me\one