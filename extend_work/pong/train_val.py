...
from extend_work.pong.dataset import *
...
if __name__ == '__main__':
    ...
    # 数据存放路径
    train_dir = 'D:\\ML\\extend_work\\pong\\train\\'
    val_dir = 'D:\\ML\\extend_work\\pong\\val\\'
    # 设置batch_size
    batch_size = 128
    # 加载数据集
    ...
    writer.close()
    print("")
# tensorboard --logdir=D:\PyCharm\PyCharmWorkPlace\RL-Group\extend_work\pong\log