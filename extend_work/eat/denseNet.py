...
class DenseNet(nn.Module):
    def __init__(self, nblocks, growth_rate, reduction, num_classes):
        ...
        self.linear = nn.Linear(5148, num_classes)
...
def DenseNet121():
    return DenseNet([6, 12, 24, 16], growth_rate=4, reduction=0.5, num_classes=4)


def DenseNet4():
    return DenseNet([6,6,6,6], growth_rate=16, reduction=0.5,num_classes=4)
